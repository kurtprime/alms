...
export default function SidebarUserButton() {
  ...
  if (isMobile) {
    return (
      <Drawer>
        <DrawerTrigger className="rounded-lg border text-accent hover:text-foreground p-3 w-full flex items-center justify-between bg-sidebar-accent hover:bg-sidebar-accent/90 overflow-hidden">
          {data.user.image ? (
