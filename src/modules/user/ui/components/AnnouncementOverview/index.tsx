...
export default function AnnouncementOverview({ classId, session }: Props) {
  ...
  const { mutate: createAnnouncement, isPending: isCreatingAnnouncement } =
    useMutation(
  ...
  return (
    <Card className="border-none shadow-none bg-transparent px-7">
      <CardHeader className="flex flex-row items-center justify-between px-0">
        <div>
          ...
          <CardDescription>
            Updates and messages from your teacher
          </CardDescription>
        </div>
              ...
              <div
                ...
                onClick={
                  item.lessonType
                    ? () =>
                        router.push(
                          `${classId}/${item.lessonType!.type}/${item.lessonType!.id}`,
                        )
                    : undefined
                }
              >
                    ...
                    {item.type === "lesson_publish" && item.lessonType && (
                      ...
                      >
                        ...
                        <span className="truncate">
                          {item.lessonType.name || "View Lesson"}
                        </span>
